namespace Loupedeck.Zoneplus
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.Zoneplus.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.Zoneplus.Resources.Resource.txt`.
